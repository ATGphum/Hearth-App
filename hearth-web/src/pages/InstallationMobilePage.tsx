...
const IOSInstallPage = () => {
  return (
    <Flex
      ...
      alignItems={"center"}
      p="0.5rem"
      bg="radial-gradient(45.76% 56.1% at 50% 50%, rgba(255, 194, 144, 0.10) 38.35%, rgba(255, 194, 144, 0.10) 100%), radial-gradient(17.88% 32.85% at 100% 68.31%, rgba(0, 240, 255, 0.10) 0%, rgba(0, 240, 255, 0.00) 100%), radial-gradient(53.91% 90.31% at 0% 100%, rgba(255, 199, 0, 0.30) 17.13%, rgba(255, 199, 0, 0.00) 100%), radial-gradient(55.85% 107.38% at 100% 0%, rgba(112, 0, 255, 0.15) 0%, rgba(0, 102, 255, 0.00) 73.6%), radial-gradient(43.47% 88.34% at 40.78% 51.67%, rgba(255, 0, 0, 0.15) 0%, rgba(216, 0, 0, 0.00) 100%), linear-gradient(0deg, rgba(252, 112, 68, 0.05) 0%, rgba(252, 112, 68, 0.05) 100%), linear-gradient(180deg, rgba(255, 190, 126, 0.50) 0%, rgba(255, 223, 192, 0.50) 100%)"
    >
